# source: https://github.com/kvarenzn/phisap
...
class Catalog:
    ...
    def __init__(self, file: IO) -> None:
        ...
        for e in self.entries:
            if isinstance(e['primaryKey'], str) :
                self.fname_map[e['primaryKey']] = e['dependencyKey']
                
            # fix int dependency    
            for fkey in e['keys'][1:]: 
                fnamekey_map[fkey] = e['primaryKey']
        
        for fkey,fvalues in self.fname_map.items():
            if fvalues in fnamekey_map:
                self.fname_map[fkey] = fnamekey_map[fvalues]
    @classmethod
